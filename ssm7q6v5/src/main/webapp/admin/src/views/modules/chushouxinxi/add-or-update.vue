  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chushoubianhao" label="出售编号" prop="chushoubianhao">
              <el-input v-model="ruleForm.chushoubianhao" 
                placeholder="出售编号" readonly></el-input>
          </el-form-item>
        </div>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `chushouxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.chushouxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
